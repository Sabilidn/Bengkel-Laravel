...
<head>
    <meta charset="utf-8">
    <title>Bengkel Bass Motor - Car Repair HTML Template</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class="fa fa-car me-3"></i>Bengkel Bass Motor</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="/booking" class="nav-item nav-link {{ Request::is('booking') ? 'active' : '' }}">Booking
                    Service</a>
            </div>
        </div>
    </nav>
    ...
    <script src="/users/lib/tempusdominus/js/moment.min.js"></script>
    <script src="/users/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="/users/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
